...
# Problem 1
url1 = "https://api.openvolt.com/v1/interval-data?meter_id=6514153c23e3d1424bf82738&granularity=month&start_date=2023-01-01&end_date=2023-01-31"
...
# Problem 2
url2 = "https://api.openvolt.com/v1/interval-data?meter_id=6514167223e3d1424bf82742&granularity=hh&start_date=2023-01-01&end_date=2023-02-1"
...
half_hourly_consumption['consumption'] = half_hourly_consumption['consumption'].astype(float)
half_hourly_carbon['building_emissions'] = half_hourly_consumption['consumption'] * half_hourly_carbon['actual']
total_carbon_emissions = half_hourly_carbon['building_emissions'].sum()
